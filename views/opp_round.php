                    ...
                    <td colspan="4"><table width="90%" border="0" align="center" cellpadding="1" cellspacing="1">
                            ...
                            <tr>
                                ...
                                <td width="454"><div class="form-group">  
                                        <?php if (empty($_SESSION['ilmoitus']) && empty($_SESSION['viimeinen'])): ?>
                                            <div class="btn-group btn-group-lg">
                                                ...
                                                <button type="submit" name="lopetusNappi" class="btn btn-xs btn-danger">Lopeta tentti</button>                                                    
                                            </div>     
                                        <?php endif; ?>        
                                        </form>
                                    </div></td>
                                ...
                                <?php if (!empty($_SESSION['ilmoitus'])): ?>        
                                    <td width="377" height="40" colspan="3">        
                                        <div class="alert alert-danger">
                                            <?php echo $_SESSION['ilmoitus']; ?><b>'<?php echo $data->kyssari; ?></b>'. Sitä ei enää kysytä tässä tentissä. Huomaa, että jokainen ohitus pienentää pistetulostasi!<br>
                                            Oikea vastaus on <b>'<?php echo $data->spoileri; ?>'</b>.
                                            <div align="left" class="btn-group btn-group-lg">
                                                <form role="form" method="POST" action="kysely_2.php">
                                                    <?php if (empty($_SESSION['viimeinen'])): ?>
                            ...
                            <tr>
                                <?php if (!empty($_SESSION['viimeinen'])): ?>        
                                    <td width="377" height="40" colspan="3">        
                                        <div class="alert alert-danger">
                                            <b><?php echo $_SESSION['viimeinen']; ?> Paina nappia jatkaaksesi yhteenvetosivulle.<br><br>
                                            </b>
                                            <div align="center" class="btn-group btn-group-lg">
                                                <form role="form" method="POST" action="kysely_2.php">
                                                    <button type="submit" name="poisNappi" class="btn btn-default">Tentti on päättynyt</button> 
                                                </form></div>
                                        </div>
                                    </td>
                                    <?php
                                    unset($_SESSION['viimeinen']);
                                endif;
                                ?>
                            </tr>
                        </table>
